...
We aspire to leverage commonalities in assays to enable a common computational workflow to process many single cell transcriptomics modalities. There will be some differences between assays that will have to be specifically addressed in the workflows, but many common steps will be leveraged among assays.
