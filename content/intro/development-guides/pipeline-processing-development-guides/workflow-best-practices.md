---
path: "/intro/development-guides/pipeline-processing-development-guides/workflow-best-practices"
date: "2018-05-03"
...
- *Do*: Incorporate into your testing the execution of the pipeline in multiple execution environments; see, for example: [HCA DCP portability service](/intro/userguides/data-processing-pipelines/pipeline-portability).
